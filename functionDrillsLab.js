...
// console.log(bestMovie('The Other Guys'))
...
//CODE HERE
function nameConfirm(str){
  console.log(str.toUpperCase())
}
nameConfirm(sampleString)
////////////////// PROBLEM 18 ////////////////////
/*
...
function emailCheck(email) {
 ...
 newEmail = emailCheck(' acebrazell49@gmail.com ')
...
const totalFrogs = frogAllowance()
console.log(frogAllowance(4))
...
const totalFrogs2 = frogAllowance2()
console.log(frogAllowance2(100))
...
//CODE HERE
function testArrayAscending(arr){
  const testArray = arr[0]
  for (let i = 0; i < arr.length - 1; i++){
  if (arr[i] <= testArray) {
    return false
  } else {
    testArrayAscending = arr[i]
  }
  }
  return true
}

const arrayIsAscending = testArrayAscending(sampleArray)
